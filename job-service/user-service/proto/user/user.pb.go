...
const file_proto_user_user_proto_rawDesc = "" +
	"\n" +
	"\x15proto/user/user.proto\x12\x04user\"\xe7\x01\n" +
	"\x04User\x12\x0e\n" +
	...
	"\n" +
	"UpdateUser\x12\x17.user.UpdateUserRequest\x1a\x18.user.UpdateUserResponseB5Z3github.com/freelance-market/user-service/proto/userb\x06proto3"
