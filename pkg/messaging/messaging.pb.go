...
func (x *Dialog) GetOtherUserId() string {
	if x != nil {
...
func (x *GetDialogsRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
const file_messaging_proto_rawDesc = "" +
	...
	"\adialogs\x18\x01 \x03(\v2\x11.messaging.DialogR\adialogs2\xf9\x01\n" +
	"\x10MessagingService\x12L\n" +
	"\vSendMessage\x12\x1d.messaging.SendMessageRequest\x1a\x1e.messaging.SendMessageResponse\x12L\n" +
	"\vGetMessages\x12\x1d.messaging.GetMessagesRequest\x1a\x1e.messaging.GetMessagesResponse\x12I\n" +
	"\n" +
	"GetDialogs\x12\x1c.messaging.GetDialogsRequest\x1a\x1d.messaging.GetDialogsResponseB4Z2github.com/bekgm/Final-AP2/pkg/messaging;messagingb\x06proto3"
...
var file_messaging_proto_goTypes = []any{
	...
	(*Dialog)(nil),              // 1: messaging.Dialog
	(*SendMessageRequest)(nil),  // 2: messaging.SendMessageRequest
	(*SendMessageResponse)(nil), // 3: messaging.SendMessageResponse
	(*GetMessagesRequest)(nil),  // 4: messaging.GetMessagesRequest
	(*GetMessagesResponse)(nil), // 5: messaging.GetMessagesResponse
	(*GetDialogsRequest)(nil),   // 6: messaging.GetDialogsRequest
	(*GetDialogsResponse)(nil),  // 7: messaging.GetDialogsResponse
}
var file_messaging_proto_depIdxs = []int32{
	0, // 0: messaging.Dialog.last_message:type_name -> messaging.Message
	0, // 1: messaging.SendMessageResponse.message:type_name -> messaging.Message
	0, // 2: messaging.GetMessagesResponse.messages:type_name -> messaging.Message
	1, // 3: messaging.GetDialogsResponse.dialogs:type_name -> messaging.Dialog
	2, // 4: messaging.MessagingService.SendMessage:input_type -> messaging.SendMessageRequest
	4, // 5: messaging.MessagingService.GetMessages:input_type -> messaging.GetMessagesRequest
	6, // 6: messaging.MessagingService.GetDialogs:input_type -> messaging.GetDialogsRequest
	3, // 7: messaging.MessagingService.SendMessage:output_type -> messaging.SendMessageResponse
	5, // 8: messaging.MessagingService.GetMessages:output_type -> messaging.GetMessagesResponse
	7, // 9: messaging.MessagingService.GetDialogs:output_type -> messaging.GetDialogsResponse
